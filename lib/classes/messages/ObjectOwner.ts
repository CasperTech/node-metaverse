...
export class ObjectOwnerMessage implements MessageBase
{
    name = 'ObjectOwner';
    messageFlags = MessageFlags.Zerocoded | MessageFlags.FrequencyLow;
    id = Message.ObjectOwner;
    ...
    readFromBuffer(buf: Buffer, pos: number): number
    {
        ...
        newObjHeaderData['OwnerID'] = new UUID(buf, pos);
        pos += 16;
        newObjHeaderData['GroupID'] = new UUID(buf, pos);
        pos += 16;
