...
(function (TSM) {
    ...
    multiplyVec4(vector, TSM.vec4, dest, TSM.vec4 | null, null);
    TSM.vec4;
    {
        if (!dest) {
            dest = new TSM.vec4();
    ...
    rotate(angle, number, axis, TSM.vec3);
    mat4 | null;
    {
